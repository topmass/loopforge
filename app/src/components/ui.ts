...
> = {
  live: {
    dot: "radar-dot text-accent bg-accent",
    pill: "border-accent bg-accent-soft text-accent-ink",
    label: "live",
  },
  done: {
    dot: "bg-ok",
    pill: "border-ok bg-ok-soft text-ok-ink",
    label: "done",
  },
  blocked: {
    dot: "bg-warn",
    pill: "border-warn bg-warn-soft text-warn-ink",
    label: "blocked",
  },
  held: {
    dot: "bg-warn",
  ...
  idle: {
    dot: "bg-ink-faint",
    pill: "border-line bg-surface-sunken text-ink-muted",
    label: "idle",
  },
};
